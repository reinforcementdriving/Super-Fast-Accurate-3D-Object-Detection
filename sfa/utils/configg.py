...
# email:
-----------------------------------------------------------------------------------
# Description: for convenient evaluation, I borrowed the code.
# Refer from: https://github.com/qianguih/voxelnet/blob/master/config.py
"""
...
if __C.DETECT_OBJ == 'Car':
    ...
    __C.ANCHOR_W = 1.6
    __C.ANCHOR_H = 1.56
    __C.ANCHOR_Z = -1.0 - cfgp.ANCHOR_H/2
    __C.RPN_POS_IOU = 0.6
    ...
    __C.ANCHOR_W = 0.6
    __C.ANCHOR_H = 1.73
    __C.ANCHOR_Z = -0.6 - cfgp.ANCHOR_H/2
    __C.RPN_POS_IOU = 0.5
